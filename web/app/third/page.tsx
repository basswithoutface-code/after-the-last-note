                            ...
                            const goListening = () => {
                                clearTimers();
                                    router.push("/listening");
                                        ...
                                        const goRecordOrPremium = () => {
                                            clearTimers();
                                                const check = canUse("record_submit");
                                                    if (!check.ok) {
                                                          router.push("/premium");
                                                                return;
                                                                    }
                                                                                ...
                                                                                clearTimers();
                                                                                    ...
                                                                                    timers.current.push(window.setTimeout(() => setStage(1), BEAT));
                                                                                        timers.current.push(window.setTimeout(() => setStage(2), BEAT + GAP_1));
                                                                                            timers.current.push(window.setTimeout(() => setStage(3), BEAT + GAP_1 + GAP_2));
                                                                                                timers.current.push(
                                                                                                      window.setTimeout(() => goListening(), BEAT + GAP_1 + GAP_2 + AUTO_AFTER_STAY)
                                                                                                          );
                                                                                                                              ...
                                                                                                                              return (
                                                                                                                                  <main className="screen" onClick={onTapAnywhere}>
                                                                                                                                        <section className="stack" aria-label="Identity choice">
                                                                                                                                                {stage >= 1 && (
                                                                                                                                                          <p className={`mainLine ${stage === 1 ? "fadeIn" : ""}`}>Who are you</p>
                                                                                                                                                                  )}
